# Drokpo — App Store metadata

Canonical copy for the App Store Connect listing. Update here first, then paste into ASC.
...
Your location is only used to show you people within your chosen distance — it's never shown to other members.
